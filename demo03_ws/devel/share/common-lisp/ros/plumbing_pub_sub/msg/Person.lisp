...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Person>)))
  ...
  (cl:format cl:nil "# int8, int16, int32, int64 (或者无符号类型: uint*)~%# float32, float64~%# string~%# time, duration~%# other msg files~%# variable-length array[] and fixed-length array[C]~%~%string name~%uint16 age~%float64 height~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Person)))
  "Returns full string definition for message of type 'Person"
  (cl:format cl:nil "# int8, int16, int32, int64 (或者无符号类型: uint*)~%# float32, float64~%# string~%# time, duration~%# other msg files~%# variable-length array[] and fixed-length array[C]~%~%string name~%uint16 age~%float64 height~%~%"))
